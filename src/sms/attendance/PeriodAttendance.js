...
const PeriodAttendance = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!selectedClass || !selectedDate || !selectedSubject || !selectedPeriod) {
    ...
    const existingAttendance = attendance.find(
      att => att.date === selectedDate && 
             ...
             att.period === parseInt(selectedPeriod) &&
             (!selectedSection || att.sectionName === (selectedSectionObj?.name || ''))
    );

    if (existingAttendance) {
      if (window.confirm('Period attendance for this date already exists. Do you want to update it?')) {
      ...
      alert('Period attendance marked successfully!');
    }
  };
    ...
    <main id="main" className="main">
      <div className="container-fluid">
        <div className="pagetitle">
          <h1>Period-wise Attendance</h1>
          <nav>
            <ol className="breadcrumb">
              <li className="breadcrumb-item"><Link to="/">Home</Link></li>
              <li className="breadcrumb-item"><Link to="/attendance">Attendance</Link></li>
              <li className="breadcrumb-item active">Period-wise Attendance</li>
            </ol>
          </nav>
        </div>
            ...
            <div className="col-lg-12">
              <div className="card">
                <div className="card-body">
                  <h5 className="card-title">Mark Period-wise Attendance</h5>
                      ...
                      <div className="table-responsive">
                        ...
                        <div className="text-end mt-3">
                          <button type="submit" className="btn btn-primary btn-lg">
                            <i className="bi bi-save"></i> Save Period Attendance
                          </button>
                        </div>
                      </div>
                    )}
