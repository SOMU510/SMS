...
const EditTeacher = () => {
  ...
  const { id } = useParams();
  const { teachers, updateTeacher, classes, subjects } = useSchool();
  const teacher = teachers.find(t => t.id === parseInt(id));

  const [formData, setFormData] = useState({
    firstName: '', lastName: '', email: '', phone: '', dateOfBirth: '',
    gender: 'Male', address: '', qualification: '', experience: '',
    subject: '', class: '', joiningDate: '', salary: '', status: 'Active'
  });
    ...
    return (
      <main id="main" className="main">
        <div className="container-fluid">
          <div className="pagetitle"><h1>Teacher Not Found</h1></div>
        </div>
      </main>
    );
  }
                ...
                <div className="card-body">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="text-end">
                      ...
                      <button type="submit" className="btn btn-primary"><i className="bi bi-save"></i> Update Teacher</button>
                    </div>
                  </form>
                </div>
              </div>
