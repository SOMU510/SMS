...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      menuKey: 'students',
      children: [
        { label: 'Student Admission 1', path: '/students/admission' },
        { label: 'Student Registration 2', path: '/students/registration' },
        { label: 'Student List 3', path: '/students' },
        { label: 'Class & Section Allocation 4', path: '/students/allocation' },
